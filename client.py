...
async def main():
    tickets = [
        ...
        Ticket("TEMP-006", "Frank Miller", "Out of ideas", "low", "initialized"),
        Ticket("TEMP-007", "Spongebob Squarepants", "Job stinks", "high", "initialized"),
        Ticket("TEMP-008", "Patrick Star", "Adulting is hard", "low", "initialized"),
        Ticket("TEMP-009", "Mr Krab", "Calculator broke", "low", "initialized"),
        Ticket("TEMP-010", "Kevin Flynn", "Pet project went rogue", "high", "initialized"),
